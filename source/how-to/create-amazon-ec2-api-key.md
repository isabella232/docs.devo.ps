...
1. Click on the `IAM` service
    ...
    <p align='center'><img src='/images/ec2_api_iam.png' alt='AWS IAM' /></p>

1. Click on the `Users` item in the left menu

    <p align='center'><img src='/images/ec2_api_iam_menu.png' alt='AWS IAM Menu' /></p>

1. Click on `Create` and enter a user (devo.ps for example)

    <p align='center'><img src='/images/ec2_api_create.png' alt='AWS IAM create' /></p>
...
1. You are now presented with the current user, click on the `Attach user policy` to set permissions
    ...
    <p align='center'><img src='/images/ec2_api_iam_details.png' alt='AWS IAM user details' /></p>
...
1. To simplify your life, use the templated rules, and select `Amazon EC2 Full Access` and apply the policy.
    ...
    <p align='center'><img src='/images/ec2_api_iam_policy.png' alt='AWS IAM user policy' /></p>
...
1. You will then be presented with a text version of the policies, finally click `Apply Policy`.
    ...
    <p align='center'><img src='/images/ec2_api_iam_apply.png' alt='AWS IAM' /></p>
