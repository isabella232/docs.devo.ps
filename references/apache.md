...
-   default: 300
-   description: The number of seconds before receives and sends time
    out.
-   type: integer
-   required: false
-   minimum: 0
...
-   default: 100
-   description: The maximum number of requests to allow during a
...
-   default: 5
-   description: Number of seconds to wait for the next request from the
...
-   default: 2
-   description: Minimum number of server processes which are kept
    spare.
-   type: integer
-   required: false
-   minimum: 0
...
-   default: 10
-   description: Maximum number of server processes which are kept
    spare.
-   type: integer
-   required: false
-   minimum: 0
...
-   default: 64
-   description: ThreadsPerChild can be changed to this maximum value
...
-   default: 25
-   description: Constant number of worker threads in each server
    process.
-   type: integer
-   required: false
-   minimum: 0
